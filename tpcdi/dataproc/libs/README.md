...
- `--format delta`: pass **both** spark-xml and Delta (comma-separated):  
  `--jars=gs://your-bucket/tpcdi/libs/spark-xml_2.13-0.18.0.jar,gs://your-bucket/tpcdi/libs/delta-spark_2.13-3.0.0.jar`
