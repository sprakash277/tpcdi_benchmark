-- ============================================================================
-- TPC-DI v2: Bronze Layer - Incremental Load (Batch 2+) - Dataproc
-- ============================================================================
-- Loads raw files from Batch{N}/ directory in GCS into Bronze tables
-- Uses APPEND mode to add incremental data
-- ============================================================================

-- Set variables (adjust GCS paths and batch_id as needed)
