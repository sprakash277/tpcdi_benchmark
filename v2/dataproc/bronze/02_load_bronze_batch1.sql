-- ============================================================================
-- TPC-DI v2: Bronze Layer - Batch 1 Load (Historical) - Dataproc
-- ============================================================================
-- Loads raw files from Batch1/ directory in GCS into Bronze tables
-- All data stored as STRING to ensure ingestion never fails
-- ============================================================================

-- Set variables (adjust GCS paths as needed)
...
-- Note: Dataproc requires spark-xml JAR (com.databricks:spark-xml_2.12:0.18.0)
