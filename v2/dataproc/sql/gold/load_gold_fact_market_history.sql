...
CREATE TABLE __CATALOG__.__SCHEMA__.gold_fact_market_history USING DELTA AS
SELECT 
    dd.sk_date_id,
    ds.sk_security_id,
    dc.sk_company_id,
...
LEFT JOIN __CATALOG__.__SCHEMA__.gold_dim_company dc ON TRIM(CAST(ds.company_id AS STRING)) = TRIM(CAST(dc.company_id AS STRING))
