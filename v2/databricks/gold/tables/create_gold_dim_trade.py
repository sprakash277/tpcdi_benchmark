...
# MAGIC %md
# MAGIC # Create Gold Table: gold_dim_trade
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Gold Layer - Create gold_dim_trade
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS gold_dim_trade (
# MAGIC     sk_trade_id BIGINT NOT NULL,
# MAGIC     trade_id BIGINT NOT NULL,  -- Natural key
