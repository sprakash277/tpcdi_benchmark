...
# MAGIC %md
# MAGIC # Create Gold Table: gold_dim_date
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Gold Layer - Create gold_dim_date
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS gold_dim_date (
# MAGIC     sk_date_id INT NOT NULL,
# MAGIC     date_id INT NOT NULL,  -- Same as sk_date_id
