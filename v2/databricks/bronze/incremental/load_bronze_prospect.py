...
# Incremental load bronze_prospect (widgets set by orchestrator)
...
spark.sql(f"""
INSERT INTO {catalog}.{schema_name}.bronze_prospect (raw_line, _batch_id, _load_timestamp, _source_file)
SELECT 
    value AS raw_line,
