...
# MAGIC %md
# MAGIC # Create Bronze Table: bronze_time
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Bronze Layer - Create bronze_time
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS bronze_time (
# MAGIC     raw_line STRING,                   -- Pipe-delimited (10 columns)
# MAGIC     _batch_id INT,
