...
# MAGIC %md
# MAGIC # Create Bronze Table: bronze_prospect
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Bronze Layer - Create bronze_prospect
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS bronze_prospect (
# MAGIC     raw_line STRING,                   -- Comma-delimited (23 columns)
# MAGIC     _batch_id INT,
