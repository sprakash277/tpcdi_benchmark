...
# MAGIC %md
# MAGIC # Create Bronze Table: bronze_trade
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Bronze Layer - Create bronze_trade
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS bronze_trade (
# MAGIC     raw_line STRING,                   -- Pipe-delimited (16 cols historical, 18 cols incremental)
# MAGIC     _batch_id INT,
