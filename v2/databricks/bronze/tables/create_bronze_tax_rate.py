...
# MAGIC %md
# MAGIC # Create Bronze Table: bronze_tax_rate
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Bronze Layer - Create bronze_tax_rate
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS bronze_tax_rate (
# MAGIC     raw_line STRING,                   -- Pipe-delimited (3 columns)
# MAGIC     _batch_id INT,
