...
# MAGIC %md
# MAGIC # Create Bronze Table: bronze_hr
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Bronze Layer - Create bronze_hr
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS bronze_hr (
# MAGIC     raw_line STRING,                   -- Comma-delimited (9 columns)
# MAGIC     _batch_id INT,
