...
# MAGIC %md
# MAGIC # Create Bronze Table: bronze_industry
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Bronze Layer - Create bronze_industry
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS bronze_industry (
# MAGIC     raw_line STRING,                   -- Pipe-delimited (3 columns: IN_ID|IN_NAME|IN_SC_ID)
# MAGIC     _batch_id INT,
