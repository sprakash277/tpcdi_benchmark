...
# MAGIC %md
# MAGIC # Create Bronze Table: bronze_trade_type
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Bronze Layer - Create bronze_trade_type
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS bronze_trade_type (
# MAGIC     raw_line STRING,                   -- Pipe-delimited (4 columns)
# MAGIC     _batch_id INT,
