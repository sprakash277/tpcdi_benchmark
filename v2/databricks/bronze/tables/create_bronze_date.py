...
# MAGIC %md
# MAGIC # Create Bronze Table: bronze_date
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Bronze Layer - Create bronze_date

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS bronze_date (
# MAGIC     raw_line STRING,                   -- Pipe-delimited (18 columns)
# MAGIC     _batch_id INT,
