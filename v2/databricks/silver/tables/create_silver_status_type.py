...
# MAGIC %md
# MAGIC # Create Silver Table: silver_status_type
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Silver Layer - Create silver_status_type
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS silver_status_type (
# MAGIC     st_id STRING NOT NULL,
# MAGIC     st_name STRING,
