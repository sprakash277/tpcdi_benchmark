...
# MAGIC %md
# MAGIC # Create Silver Table: silver_tax_rate
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS silver_tax_rate (
# MAGIC     tx_id STRING NOT NULL,
# MAGIC     tx_name STRING,
# MAGIC     tx_rate DOUBLE,
