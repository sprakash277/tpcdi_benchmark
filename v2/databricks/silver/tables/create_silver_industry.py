...
# MAGIC %md
# MAGIC # Create Silver Table: silver_industry
...
# COMMAND ----------
# MAGIC %sql
# MAGIC -- TPC-DI v2: Silver Layer - Create silver_industry
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS silver_industry (
# MAGIC     in_id STRING NOT NULL,
# MAGIC     in_name STRING,
# MAGIC     in_sc_id STRING,  -- Sector ID
